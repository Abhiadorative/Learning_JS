let names = ["Abhi", "Gayatriri", "Devangi"];
let lastnames = ["Salvatore", "Kumari"];

console.log(names); //[ 'Abhi', 'Gayatriri', 'Devangi' ]
let aaa = names+lastnames; // this becomes string
console.log(typeof aaa);// Abhi,Gayatriri,DevangiSalvatore,Kumari// if we simply add 2 arrays it becomes string.

//to add two arrays as arrays
let conArr = names.concat(lastnames); // it joints 2 arrays
console.log(conArr);

//push method only add one as a single value in another array ["Abhi",["Salvatore"]];// like this
...
console.log(Array.from("Abhi")); // return an array from every given string. ['A','t','h','a','r','v']; // takes objects and all
