...
console.log(myDate); // 2024-09-18T03:42:48.448Z
console.log(myDate.toString()); // Mon Apri 18 2024 09:16:57 GMT+0530 (India Standard Time)
console.log(myDate.toDateString()); // Mon Apri 18 2024
console.log(myDate.toLocaleTimeString()); // 9:17:38 AM
console.log(myDate.toLocaleString()); // 9/18/2024, 9:18:10 AM
console.log(myDate.toJSON()); // 2024-09-18T03:48:47.585Z

let myCreatedDate = new Date(2024, 0, 23) //YYYY, Month starts with 0 and DD
...
let myNewDate = new Date("01-01-2024"); // this is suppose to give this format however it is giving indian format MM-DD-YYYY
console.log(myNewDate.toLocaleString()); // 1/1/2024, 12:00:00 AM
